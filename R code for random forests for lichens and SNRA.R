...
vars = c("LobaOreg","TransAspect","Elevation","Slope","ACONIF","PctConifCov","DegreeDays","EvapoTransAve",
         "EvapoTransDiff","MoistIndexAve","MoistIndexDiff", "TempDiff","PrecipAve", "TempAve")
lichenLO = laqi[vars]
...
Loreg.rf=randomForest(as.factor(LobaOreg)~ . ,data=lichenLO) #use as.factor for classification tree, otherwise regression tree
